...
//
    ...
    Map<String, String>  wantStringMap(Message message,String key) {
        ...
        {
            errorRecorder.recordError("wantStringMap  key " + key + " error:" + e);
        }
        return map;
    }
    ...
    void wantLongList(Message message,String key, List<Long> list) {
        ...
        {
            errorRecorder.recordError("wantLongList  key " + key + " error:" + e);
        }
    }
    ...
    void wantIntList(Message message,String key, List<Integer> list) {
        ...
        {
            errorRecorder.recordError("wantIntList  key " + key + " error:" + e);
        }
    }
    ...
    void getIntList(Message message,String key, List<Integer> list) {
        ...
        try {
            ...
            errorRecorder.recordError("getIntList  key " + key + " error:" + e);
        }
    }
    ...
    void getStringList(Message message,String key, List<String> list) {
        ...
        try {
            ...
            errorRecorder.recordError("getStringList  key " + key + " error:" + e);
        }
    }
    ...
    List<Map<String, String>> wantListHashMap(Message message, String key) {
        ...
        {
            errorRecorder.recordError("wantListHashMap  key " + key + " error:" + e);
        }
        return attributes;
    }
    ...
    HashMap<Long, HashSet<Integer>> wantDeviceOption(Message message, String key) {
        ...
        {
            errorRecorder.recordError("wantDeviceOption  key " + key + " error:" + e);
        }
        return options;
    }
    ...
    HashSet<Long> wantLongHashSet(Message message, String key) {
        ...
        {
            errorRecorder.recordError("wantLongHashSet  key " + key + " error:" + e);
        }
        return uids;
    }
