        ...
        return token;
            ...
            public static String genEd25519Token(long pid, long uid, String secret,long ts) {
                ...
                try {
                    ...
                    byte[] pkcs8 = Base64.getDecoder().decode(keyBuffer);
                    ...
                    token = Base64.getEncoder().encodeToString(sigbytes);
...
//        String token = "11000001:666:1669174320";
        String realKey = "";
        try {
             realKey =new String( Base64.getDecoder().decode(secret));
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//        String md5data = md5string(token);
    ...
    private static String hmacSha(String KEY, String VALUE, String SHA_TYPE) {
        ...
        try {
            ...
            retVal= Base64.getEncoder().encodeToString(digest);
